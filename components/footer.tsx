  ...
  return (
    <footer className="bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 text-white relative overflow-hidden">
      ...
      <div className="absolute inset-0 opacity-5">
        <div className="absolute top-0 left-0 w-full h-full bg-gradient-to-r from-red-500/10 to-gray-500/10" />
        <div className="absolute top-10 left-10 w-32 h-32 border border-red-500/20 rounded-full" />
        <div className="absolute bottom-10 right-10 w-24 h-24 border border-gray-500/20 rounded-full" />
        <div className="absolute top-1/2 left-1/3 w-16 h-16 border border-red-400/20 rounded-full" />
      </div>
        ...
        <div className="max-w-7xl mx-auto px-6 py-16">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
            ...
            <div className="lg:col-span-1">
              <div className="mb-8">
                <h3 className="text-2xl font-bold mb-4 bg-gradient-to-r from-red-400 to-gray-300 bg-clip-text text-transparent">
                  Aqstoria
                </h3>
                ...
                <div className="flex items-center text-gray-400">
                  <Clock className="h-4 w-4 mr-3 text-red-400" />
            ...
            <div>
              ...
              <div className="space-y-4 mb-8">
                ...
                <div className="flex items-center">
                  <MessageCircle className="h-5 w-5 mr-4 text-red-400" />
                  <a
                ...
                <div className="flex space-x-4">
                  {[
                    ...
                    <a
                      ...
                      className="w-10 h-10 rounded-full bg-gray-800 hover:bg-gradient-to-r hover:from-red-500 hover:to-red-600 flex items-center justify-center transition-all duration-300 transform hover:scale-110 group"
                      title={social.label}
                    >
