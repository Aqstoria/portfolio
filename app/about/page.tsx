        ...
        <div className="relative py-8 px-6">
          <div className="max-w-6xl mx-auto">
                ...
                <div className="space-y-12">
                  ...
                  <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                    ...
                    <div className="relative">
                      <div className="bg-gradient-to-br from-blue-50 via-white to-cyan-50 dark:from-blue-900/20 dark:via-gray-800 dark:to-cyan-900/20 rounded-3xl p-8 shadow-2xl border border-white/20 dark:border-gray-700/20">
                        <div className="text-center">
                ...
                <div className="space-y-12">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    {teamMembers.map((member, index) => (
                      <Card
                        key={index}
                        className="group bg-white/90 dark:bg-gray-800/90 backdrop-blur-sm border-0 hover:scale-105 transition-all duration-500 shadow-xl hover:shadow-2xl text-center overflow-hidden"
                      >
                        <CardContent className="p-8">
                          <div className="relative mb-8">
                            ...
                            >
                              <div className="w-full h-full rounded-3xl bg-white dark:bg-gray-700 flex items-center justify-center">
                                <member.icon className="h-10 w-10 text-gray-700 dark:text-gray-300" />
                              </div>
                            </div>
                          ...
                          <h3 className="text-xl font-bold mb-2 text-gray-800 dark:text-white group-hover:text-gray-900 dark:group-hover:text-gray-100 transition-colors duration-300">
                            {member.name}
                          </h3>
                          <p className="text-blue-600 dark:text-blue-400 font-semibold mb-3 text-sm">{member.role}</p>
                          <p className="text-gray-600 dark:text-gray-400 text-xs leading-relaxed mb-4">{member.speciality}</p>
                          ...
                          <div className="flex flex-wrap gap-1 justify-center">
                            {member.skills.slice(0, 3).map((skill, skillIndex) => (
                              <Badge
                                key={skillIndex}
                                variant="secondary"
                                className="text-xs bg-blue-50 dark:bg-blue-900/50 text-blue-700 dark:text-blue-300 border-blue-200 dark:border-blue-700"
                              >
                                {skill}
                              </Badge>
                            ))}
                      ...
                      {timeline.map((item, index) => (
                        <div key={index} className={`flex items-center ${index % 2 === 0 ? 'flex-row' : 'flex-row-reverse'}`}>
                          <div className="w-1/2 px-8">
                            <Card className="bg-white/90 dark:bg-gray-800/90 backdrop-blur-sm border-0 shadow-xl hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-1">
                      ...
                      >
                        <CardContent className="p-8">
                          <div className="flex items-center mb-6">
                            ...
                            <div>
                              <h3 className="text-xl font-bold mb-2 text-gray-800 dark:text-white">{award.title}</h3>
                              <p className="text-gray-600 dark:text-gray-400 text-sm">{award.organization}</p>
                              <p className="text-blue-600 dark:text-blue-400 font-semibold text-sm">{award.year}</p>
                            </div>
                          </div>
                        </CardContent>
                      </Card>
            ...
            <div className="mt-20">
              ...
              <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-8">
                {stats.map((stat, index) => (
                  <Card
                    key={index}
                    className="bg-white/90 dark:bg-gray-800/90 backdrop-blur-sm border-0 text-center hover:scale-110 transition-all duration-500 shadow-xl hover:shadow-2xl transform hover:-translate-y-2"
                  >
                    <CardContent className="p-6">
                      <div
                      ...
                      <div className="text-2xl font-bold mb-2 text-gray-800 dark:text-white">{stat.value}</div>
            ...
            <div className="mt-20 text-center bg-gradient-to-r from-blue-50/50 to-cyan-50/50 dark:from-blue-900/20 dark:to-cyan-900/20 backdrop-blur-sm rounded-3xl p-12 border border-white/20 dark:border-gray-700/20 shadow-xl">
              <h3 className="text-3xl font-bold mb-6 text-gray-800 dark:text-white">Ready to Work With Us?</h3>
